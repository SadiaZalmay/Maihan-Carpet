...
<?php
  if (isset($_POST['submit'])) {
   ...
   if(empty($filename)) {
      $Update = "UPDATE gsection SET  Heading = '$Heading' WHERE Id = '$EditHId'";
    ...
    elseif(!empty($filename)){
        ...
        $Update = "UPDATE gsection SET  Heading = '$Heading',Img = '$Destination' WHERE Id = '$EditHId'";
        if ($connection->query($Update)) {
          $_SESSION['EditHSuccess']="Data has been Successfully Edited!";
         header("Location:gsection.php");
        }
...
?>
 ...
 <form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="modal-footer float-left">
      <a href="gsection.php"><button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button></a>
